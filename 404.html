...
<head>
  ...
  <title>Movie - Not Found </title><!-- Styles-->
        ...
        <div class="error-wrap">
          <section class="max-md">
            <div class="row">
              ...
              <div class="col-md-8 pa-3">
                <div class="text">
                  <h4 class="display-1">This page could not be found.</h4>
                  <p>You can either stay and chill here, or go back to the beginning.</p>
                  <a class="btn btn-outlined primary waves-effect button" href="index.html">back to home</a>
                </div>
              </div>
            </div>
          </section>
